      ...
      <AnimatePresence initial={false}>
        {open && (
          <motion.aside
            ...
            className="glass-strong rounded-2xl w-[300px] flex flex-col overflow-hidden shadow-2xl shadow-forest-900/10"
          >
                ...
                <div className="grid grid-cols-2 gap-2">
                  {filtered.map((tree) => (
                    <div
                      ...
                      className="group cursor-grab active:cursor-grabbing rounded-xl bg-white/70 dark:bg-forest-900/40 hover:bg-white dark:hover:bg-forest-900/80 border border-forest-200/40 dark:border-forest-800/40 hover:border-forest-300 dark:hover:border-forest-700 p-2 transition-all"
                    >
                      <div className="aspect-square flex items-end justify-center">
                        <TreeIllustration svg={tree.svg} imagePath={tree.imagePath} alt={tree.name} className="w-full max-w-[80px] aspect-square" />
                      </div>
