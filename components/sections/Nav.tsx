      ...
      >
        ...
        <div className="flex items-center gap-1 sm:gap-1.5 ml-1 sm:ml-2">
          ...
          <a
            ...
            className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-full bg-forest-900 dark:bg-forest-50 text-forest-50 dark:text-forest-900 text-[13px] font-medium hover:scale-[1.04] active:scale-[0.96] transition-transform"
          >
