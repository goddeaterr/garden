...
export function Footer() {
  ...
  return (
    <footer ref={ref} id="footer" className="relative bg-white dark:bg-forest-950 text-forest-900 dark:text-forest-50 overflow-hidden">
      ...
      >
        {/* Left vignette — light */}
        <div className="dark:hidden absolute inset-y-0 left-0 w-24 z-10 pointer-events-none"
          style={{ background: 'linear-gradient(to right, #ffffff, transparent)' }} />
        {/* Left vignette — dark */}
        <div className="hidden dark:block absolute inset-y-0 left-0 w-24 z-10 pointer-events-none"
          style={{ background: 'linear-gradient(to right, rgb(12,22,14), transparent)' }} />
        {/* Right vignette — light */}
        <div className="dark:hidden absolute inset-y-0 right-0 w-24 z-10 pointer-events-none"
          style={{ background: 'linear-gradient(to left, #ffffff, transparent)' }} />
        {/* Right vignette — dark */}
        <div className="hidden dark:block absolute inset-y-0 right-0 w-24 z-10 pointer-events-none"
        ...
        <div style={{ transform: 'rotateX(8deg)', transformOrigin: 'top center' }}>
          {/* No group-hover pause — scrolls continuously */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        >
          ...
          <div className="md:col-span-5">
            ...
            <div className="mt-8 flex gap-2">
              <a
                href="#catalog"
                className="group inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-forest-950 dark:bg-forest-50 text-white dark:text-forest-950 text-sm font-medium hover:scale-[1.02] active:scale-[0.98] transition-transform"
              >
                {f.catalog}
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={l.label}>
                  <a
                    href={l.href}
                    className="text-[15px] text-forest-700 dark:text-forest-100 hover:text-forest-950 dark:hover:text-white inline-flex items-center gap-1 group transition-colors"
                  >
                    {l.label}
        ...
        {/* Bottom bar */}
        <div className="mt-20 pt-8 border-t border-forest-100 dark:border-forest-800 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
      ...
      {/* Forest panorama — dark mode only */}
      <div className="hidden dark:block absolute bottom-0 left-0 right-0 pointer-events-none overflow-hidden" aria-hidden>
        <svg viewBox="0 0 1440 160" preserveAspectRatio="xMidYMax meet" className="w-full block" xmlns="http://www.w3.org/2000/svg">
          <path fill="rgba(235,245,236,0.07)"
          ...
          />
          <path fill="rgba(235,245,236,0.04)"
